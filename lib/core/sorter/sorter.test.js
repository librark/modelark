...
describe('Sorter', () => {
  ...
  it('sorts non-primitive objects by json stringifying them first', () => {
    const dataset = [
      { name: 'John Doe', createdAt: new Date('1989-03-31') },
      { name: 'Richard Roe', createdAt: new Date('1993-02-15') },
      { name: 'Mark Moe', createdAt: new Date('1978-01-20') }
    ]

    const sorted = sorter.sort(dataset, 'createdAt desc')
