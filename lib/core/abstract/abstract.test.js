...
describe('Abstract', () => {
  ...
  it('provides a utilitarian method named "_abstract" which throws', () => {
    class CustomAbstract extends Abstract {
      customMethod (first, second) {
        this._abstract({ first, second })
      }
  ...
  it('method "_abstract" prints the return type value if given', () => {
    class CustomAbstract extends Abstract {
      customMethod (first, second) {
        this._abstract({ first, second, return: 'number' })
      }
