...
describe('Entity', () => {
  ...
  it('signals if the class has been augmented with additional fields', () => {
    ...
    const nonAugmentedInstance = new NonAugmented({ name: 'x', code: 120 })

    expect(nonAugmentedInstance.name).toEqual('x')
    expect(nonAugmentedInstance.code).toEqual(120)
    expect(nonAugmentedInstance.constructor.augmented).toEqual(false)
