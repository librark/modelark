...
describe('Repository', () => {
  ...
  it('It defines a "model" property', () => {
    expect(() => repository.model).toThrow(
      'The repository "Entity" model has not been set.')
  })

  it('It defines a "collection" property', () => {
    expect(() => repository.collection).toThrow(
      'The repository "Entity" model has not been set.')
  })

  it('It defines a "state" property', async () => {
    expect(() => repository.state).toThrow(
      'A custom "state" has not been set.')
  })
  ...
  it('Creates a clone of itself with the given "state"', () => {
    ...
    expect(() => originalRepository.state).toThrow()
